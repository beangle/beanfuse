...
function validator_exec() {
  ...
  for (var n_key in this.a_fields) {
    ...
    if (this.a_fields[n_key]['r'] && isEmpty(this.a_fields[n_key]['v'])) {
    ...
    else if (this.a_fields[n_key]['mx'] && this.a_fields[n_key]['v'] && String(this.a_fields[n_key]['v']).length > this.a_fields[n_key]['mx']) {
