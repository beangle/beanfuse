...
function initToolBar(title,imageName){   
   ...
   titleTd.innerHTML='<img class="icon" src="'+imagePath+imageName+'"><B>'+title+"</B>";
   titleTd.align="left";
...
function addItem(title,action,imageName,alt){
   ...
   itemTd.innerHTML='<img class="icon" src="'+imagePath+imageName+'" alt="' +alt+'">'+title;
...
function addMenu(title,action,imageName,alt){
   ...
   var innerHTML='<img class="icon" src="'+imagePath+imageName+'" alt="' +alt+'">'+title;
   itemTd.className="padding";
   itemTd.width="1%";// adaptive 
