...
<table width="100%" border="0">
    ...
    <tr>
      <td>
          <img src="userAvatar!show.action?user.name=${user.name}" width="100px" align="top">
      </td>
      <td width="95%">
         用户名:${user.name}<br>
         姓名:${user.fullname}<br>
 ...
 注意:上传的图片格式包括:jpg,jpeg,png,gif.
     ...
     <tr>
      <td>
	    <@s.form name="uploadForm" action="userAvatarBoard!upload.action" method="POST"  enctype="multipart/form-data">
