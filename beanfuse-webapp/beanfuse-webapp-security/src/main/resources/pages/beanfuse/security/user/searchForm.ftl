   <table class="searchTable" onkeypress="DWRUtil.onReturn(event, searchUser)">
    ...
    <form name="userSearchForm" action="user.action?method=search"  target="contentFrame" method="post">
     ...
     <tr><td colspan="2" align="center"><button onclick="searchUser();"><@text name="action.query"/></button></td></tr>
     </form>
	</table>