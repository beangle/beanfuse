 ...
 <table id="groupInfoBar"></table>
     <table class="infoTable">
	   <tr>
	     ...
	     <td class="content">${group.creator.name!}  </td>
	   </tr>	   
	   <tr>
       ...
       <tr>
        ...
        <td  class="content" colspan="3"><#list group.users?sort_by("name") as user> ${user.fullname}(${user.name})&nbsp;</#list></td>
       </tr>
	   <tr>
        <td class="title" ><@text name="group.managers"/>:</td>
        <td  class="content" colspan="3">
             <#list group.managers! as user>
