<div class="ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
    ...
    <div class="portlet-content">
      <#if (sessionActivities?size==0)>没有登录过系统<#else>
  	  ...
  	  <@table.thead>
  		<@table.td width="15%" text="登录时间" />
  		<@table.td width="15%" text="退出时间" />
  		<@table.td width="10%" text="在线时间"/>
 		<@table.td width="10%" text="主机"/>
      </@>
   	  <@table.tbody datas=sessionActivities;sessionActivity>
