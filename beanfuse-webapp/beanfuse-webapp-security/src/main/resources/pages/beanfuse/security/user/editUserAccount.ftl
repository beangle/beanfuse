    ...
    <TABLE WIDTH="100%" BORDER="0" ALIGN="CENTER" CELLPADDING="0" CELLSPACING="0">
     <TR> 
      <TD HEIGHT="100%" VALIGN="TOP">       
       <TABLE WIDTH="100%" BORDER="0" ALIGN="CENTER" CELLPADDING="0" CELLSPACING="0">
        <form name="commonForm" action="user.action?method=updateUserAccount" method="post">
        ...
        <tr> 
         <td>&nbsp;</td>
         <td id="f_email"  valign="top" width="40%"><@text name="common.email"/>:</td>
         <td class="text1"><input type="text" name="email"  value="${user.mail}" maxLength="100"/></td>
        </tr>
...
<script>
   function doAction(form){
     var a_fields = {         
         ...
         'email':{'l':'<@text name="common.email"/>', 'r':true, 'f':'email', 't':'f_email'}
     };
