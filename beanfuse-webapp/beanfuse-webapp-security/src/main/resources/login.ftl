      ...
      <TABLE width="50%" BORDER="0" CELLSPACING="0" CELLPADDING="0"  width="651"   >
       ...
       <tr>
         ...
         <tr>
          ...
          <td width="45">
           <INPUT NAME="loginForm.name" TYPE="text" value="${name!}" style="width:150px;background-color:#B0B0B0">
          </td>
         </tr>
         <tr>
          <td ALIGN="right" height="30"><STRONG>密码<#--<@text name="user.password"/>-->:</STRONG></td>
          <td><INPUT NAME="loginForm.password" TYPE="password"   style="width:150px;background-color:#B0B0B0">
          <INPUT NAME="encodedPassword" type="hidden" value=""></td>
         </tr>
         <tr>
          <td ALIGN="right" height="30"><STRONG>验证码:</STRONG></td>
          <td align="bottom"><INPUT NAME="loginForm.captcha" TYPE="text" style="width:85px;background-color:#B0B0B0">
