...
/**
 * BeanfuseWrapper不同于StrutsBeanWrapper，他扩展了DefaultObjectWrapper。提供了<br>
 * 1)缺省的对象包装<br>
 ...
 */
public class BeanfuseWrapper extends DefaultObjectWrapper {
	private boolean altMapWrapper;

	public BeanfuseWrapper(boolean altMapWrapper) {
	...
	private final static class FriendlyMapModel extends MapModel implements TemplateHashModelEx,
		...
		static final ModelFactory FACTORY = new ModelFactory() {
			public TemplateModel create(Object object, ObjectWrapper wrapper) {
				return new FriendlyMapModel((Map) object, (BeanfuseWrapper) wrapper);
			}
		};

		public FriendlyMapModel(Map map, BeanfuseWrapper wrapper) {
			super(map, wrapper);
		}
