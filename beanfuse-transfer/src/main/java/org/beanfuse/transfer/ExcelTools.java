//$Id: ExcelTools.java,v 1.11 2006/12/19 13:00:31 chaostone Exp $
/*
 *
...
public class ExcelTools {
	...
	DecimalFormat intoExcelNumberformat = new DecimalFormat("#0.00");

	public ExcelTools() {
	}

	public HSSFWorkbook toExcel(Collection datas, String propertyShowKeys) throws Exception {
		// 建立新HSSFWorkbook对象
	 ...
	 * @throws Exception
	 */
	public HSSFWorkbook toExcel(HSSFWorkbook wb, String sheetName, Collection datas,
		...
		for (Iterator iter = datas.iterator(); iter.hasNext(); rowId++) {
	 ...
	 * @throws Exception
	 */
	public HSSFWorkbook object2Excel(Collection list, String propertyKeys, String propertyShowKeys,
	 ...
	 * @throws Exception
	 */
	public HSSFWorkbook object2Excel(HSSFWorkbook wb, String sheetName, Collection list,
			String propertyKeys, String propertyShowKeys, PropertyExtractor exporter)
			throws Exception {
		HSSFSheet sheet = wb.createSheet(sheetName);
		HSSFRow row = null;
		HSSFCell cell = null;
